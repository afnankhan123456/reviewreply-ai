    ...
    <div className="min-h-screen overflow-hidden relative bg-[#f8faff]">
      ...
      <div className="relative z-10 grid xl:grid-cols-2 min-h-screen">
        ...
        <div className="flex flex-col justify-center px-6 lg:px-16 py-6 space-y-6">
          ...
          {/* 🚀 TILTED DASHBOARD OVERVIEW CARD (3D EFFECT) */}
          <div className="perspective-[1200px] max-w-[720px] mt-4">
            <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-[0_20px_60px_-15px_rgba(108,99,255,0.25)] transition-transform duration-500 transform rotateX(3deg) rotateY(-1deg) hover:rotateX(0) hover:rotateY(0)">
              ...
              <h3 className="text-base font-bold text-[#111827] mb-4">Dashboard Overview</h3>
              ...
              <div className="grid grid-cols-4 gap-3 mb-4">
                {[
                  ...
                  return (
                    <div key={i} className="bg-[#f8fafc] rounded-xl p-3 border border-[#f1f5f9] relative">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-[#f8fafc] rounded-xl p-3 border border-[#f1f5f9] h-40 flex flex-col">
