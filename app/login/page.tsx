...
export default function LoginPage() {
  ...
  return (
    <div className="h-screen overflow-hidden relative bg-[#f8faff]">
      ...
      {/* Main Content – Full viewport height, no scroll */}
      <div className="relative z-10 grid xl:grid-cols-2 h-full">
        {/* LEFT SIDE */}
        <div className="flex flex-col justify-between px-6 lg:px-16 py-4 h-full">
          ...
          {/* 🏁 BOTTOM STATS – now at the very bottom with no extra space */}
          <div className="grid grid-cols-3 gap-3 max-w-[720px] bg-[#eff1f8]/50 border border-white/60 p-3 rounded-2xl backdrop-blur-sm">
            {[
