...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative bg-[#f8faff]">
      ...
      {/* 🌊 Light blue wave at the bottom (replaced the white patch) */}
      ...
      <div className="relative z-10 grid xl:grid-cols-2 min-h-screen">
        {/* LEFT SIDE – bottom padding added so stats don't get hidden behind the wave */}
        <div className="flex flex-col justify-between px-6 lg:px-16 py-6 pb-24">
          {/* LOGO */}
