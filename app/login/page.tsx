...
export default function LoginPage() {
  ...
  return (
    <>
      {/* Remove any default body margin/padding that could cause white stripe */}
      <style>{`
        body, html {
          margin: 0;
          padding: 0;
      ...
      <div className="min-h-screen relative bg-[#f8faff]">
        ...
        {/* Main Content – no wave, no extra spacing */}
        <div className="relative z-10 grid xl:grid-cols-2 min-h-screen">
          {/* LEFT SIDE – stats at bottom due to justify-between */}
          <div className="flex flex-col justify-between px-6 lg:px-16 py-6">
            ...
            {/* 🏁 BOTTOM STATS – now firmly at the bottom edge */}
