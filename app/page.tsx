    ...
    <>
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <div className="inline-flex items-center gap-1.5 bg-white/5 border border-white/10 rounded-full px-3 py-1 mb-2.5">
          ...
          <p className="text-gray-400 text-[11px] leading-relaxed max-w-sm">
            ...
            generate AI-powered replies, respond to reviews, monitor ratings, analyze customer
            sentiment, and manage your online reputation from one dashboard.
          </p>
        </div>

        <div className="grid grid-cols-2 gap-x-3 gap-y-1.5 mt-4 max-w-sm mx-auto w-full">
          {FEATURE_CHECKLIST.map((item, i) => (
            <div key={i} className="flex items-center gap-1.5">
              <CheckCircle className="w-3.5 h-3.5 text-[#ff2d55] shrink-0" />
              <span className="text-[10px] text-gray-300 leading-tight">{item}</span>
            </div>
          ))}
        </div>

        <div className="bg-white/[0.05] rounded-xl p-2.5 border border-white/10 flex items-start gap-2 mt-4">
          <Lock className="w-3.5 h-3.5 text-[#ff2d55] shrink-0 mt-0.5" />
          <p className="text-gray-300 text-[10px] leading-snug">
            ReviewReply AI uses Google OAuth to securely connect your Google Business Profile.
            Access is requested only after you explicitly authorize your account. We never access
            Gmail, Google Drive, Contacts, Calendar, or other unrelated Google services.
          </p>
        </div>

        <div
          id="google-signin"
          className="w-full bg-black/40 backdrop-blur-md border border-[#ff2d55]/30 rounded-2xl p-4 shadow-[0_0_60px_-20px_rgba(255,45,85,0.4)] mt-4"
        >
          <button
            onClick={handleLogin}
      ...
      >
        ...
        <div className="relative z-10 grid xl:grid-cols-[1.15fr_0.85fr] gap-10 items-center max-w-6xl mx-auto w-full">
          <div className="flex flex-col">
            ...
            <p className="text-gray-400 text-sm max-w-lg leading-relaxed mb-5">
              ReviewReply AI is an AI-powered Google Business Profile review management platform.
              Securely connect your Google Business Profile to automatically sync customer
              reviews, generate AI-powered replies, respond to reviews, monitor ratings, analyze
              customer sentiment, and manage your online reputation from one dashboard.
            </p>
            ...
            <div className="bg-white/[0.05] rounded-xl p-3.5 border border-white/10 flex items-start gap-2.5 max-w-lg">
              <Lock className="w-4 h-4 text-[#ff2d55] shrink-0 mt-0.5" />
              <p className="text-gray-300 text-xs leading-relaxed">
                ReviewReply AI uses Google OAuth to securely connect your Google Business Profile.
                Access is requested only after you explicitly authorize your account. We never
                access Gmail, Google Drive, Contacts, Calendar, or other unrelated Google services.
              </p>
            </div>
          </div>
          ...
          <div
            ...
            className="bg-black/30 backdrop-blur-md border border-white/10 rounded-3xl p-8 shadow-[0_0_80px_-20px_rgba(255,45,85,0.3)] w-full max-w-sm justify-self-end"
          >
            <div className="flex justify-center mb-5">
              <div className="relative w-16 h-16 flex items-center justify-center">
                ...
                <img src="/ai-logo.png" alt="logo" className="w-11 h-11 object-contain" />
              </div>
            </div>
            ...
            <p className="text-gray-300 text-center mt-1 text-xs mb-6">
