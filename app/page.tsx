...
const HERO_CONTENT_BLOCKS = [
  ...
  },
  {
    ...
    desc: "Generate AI-powered replies, respond to reviews, monitor ratings, analyze customer sentiment, and manage your online reputation from one dashboard.",
  },
];
      ...
      >
        ...
        <div className="relative z-10 grid xl:grid-cols-[1.15fr_0.9fr] gap-14 items-center max-w-6xl mx-auto w-full">
          ...
          >
            ...
            <button
              onClick={handleLogin}
              className="w-full bg-white hover:bg-gray-100 transition-all py-3.5 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 text-[#111827] shadow-sm"
            >
              <img
                src="https://www.svgrepo.com/show/475656/google-color.svg"
                alt="Google"
