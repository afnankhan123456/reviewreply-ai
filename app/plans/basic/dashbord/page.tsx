  ...
  return (
    <div className="min-h-screen bg-[#f7f8fc]">
      <div className="p-5 lg:p-7">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-4 gap-5 mt-7">
          <div className="bg-white border border-[#e5e7eb] rounded-[26px] p-6 h-[180px] shadow-sm">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-[#6b7280] text-[15px]">Reviews Synced</p>
                <div className="flex items-end gap-2 mt-4">
                  <h2 className="text-[42px] font-bold text-[#111827] leading-none">
                    100
                  </h2>
                  <span className="text-[24px] text-[#6b7280] mb-1">/100</span>
                </div>
                <p className="text-[#6b7280] text-[14px] mt-4">This Month</p>
              </div>
          ...
          <div className="bg-white border border-[#e5e7eb] rounded-[26px] p-6 h-[180px] shadow-sm">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-[#6b7280] text-[15px]">Google Review Sync</p>
          ...
          <div className="bg-white border border-[#e5e7eb] rounded-[26px] p-6 h-[180px] shadow-sm">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-[#6b7280] text-[15px]">Average Rating</p>
          ...
          <div className="bg-white border border-[#e5e7eb] rounded-[26px] p-6 h-[180px] shadow-sm">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-[#6b7280] text-[15px]">Response Rate</p>
                <h2 className="text-[42px] font-bold text-[#111827] mt-4 leading-none">
                  85%
                </h2>
        ...
        {/* USKE NICHE - 3 SAME CARDS (Updated: 3 cards instead of 2) */}
