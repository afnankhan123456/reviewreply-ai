      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 pt-10 pb-8">
        ...
        <div className="overflow-hidden rounded-[34px] border border-white/70 bg-white/70 backdrop-blur-2xl shadow-[0_20px_80px_rgba(124,58,237,0.12)]">
          ...
          {plans.map((plan, index) => (
            <div
              key={plan.id}
              className={`grid grid-cols-5 items-center bg-white/70 backdrop-blur-xl ${
            ...
            >
              ...
              <div className="p-5 border-l border-violet-100">
                <h2 className="text-3xl md:text-4xl font-black text-[#05053b]">
                  {plan.price}
                </h2>
              </div>
        ...
        {/* FEATURE CARDS */}
        <div className="mt-8 grid grid-cols-1 md:grid-cols-4 overflow-hidden rounded-[28px] border border-white/70 bg-white/70 backdrop-blur-xl shadow-lg">
          ...
          <div className="flex items-center gap-4 border-l border-violet-100 p-6">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-violet-100">
              <RefreshCcw className="text-violet-700" />
            </div>
