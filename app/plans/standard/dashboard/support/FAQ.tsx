...
const faqs = [
  ...
  { question: "How does the AI Reply Center work?", answer: "The AI Reply Center automatically sends AI-generated replies to your reviews every hour. You can edit the reply before it goes out, or let it send on its own." },
