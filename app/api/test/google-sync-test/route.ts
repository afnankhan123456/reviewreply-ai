...
export async function GET() {
  // 📦 50 DUMMY REVIEWS (Exactly same format as the successful 22)
  const dummyReviews = [
    {
    ...
    // ==========================================
    // ✅ 28 MORE REVIEWS (Same exact format)
    // ==========================================
    {
      userId: "cmr1wiait0001jv04cbasfye3",
      businessLocationId: null,
  ...
  console.log('✅ 50 Dummy Reviews Generated (Same format as successful 22):', dummyReviews);

  // ✅ DIRECT DATABASE SAVE LOGIC
